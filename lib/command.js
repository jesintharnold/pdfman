...
class pdfcmd extends cmdfunc{
	...
	init(){
		this.entryPoint.commands.forEach((cmd)=>cmd.option("-f, --file <file...>","relative file path")
		.option("-d, --dir <folder>","root directory path").option("-o, --out <out>","output directory path"));};
